...
public class ThreadPoolUtil {
	...
	private final static ThreadPoolTaskExecutor EXECUTOR_SERVICE = SpringContextHolder
			.getBean(AsyncExecutionAspectSupport.DEFAULT_TASK_EXECUTOR_BEAN_NAME);
	 ...
	 */
	public static <T> Future<T> runCallable(Callable<T> task) {
